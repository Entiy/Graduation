function [ELM_Kernel_Model] = elm_kernel_train(TrainingData, TestingData, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
...
OutputWeight=((Omega_train+speye(n)/C)\(T')); %A\B(左除)相当于A的逆乘以B
TrainingTime=toc
...
ELM_Kernel_Model{4, 1} = Regularization_coefficient;
...
ELM_Kernel_Model{11, 1} = TestingAccuracy;  
